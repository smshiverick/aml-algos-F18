...
but the probabilities of the expected outcome are non-linear. And the terms 
in the logistic regression equation can be rearranged to obtain the function 
of the event probability (equation 3). 
