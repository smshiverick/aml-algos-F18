...
crisis in the U.S. \cite{nida18}. Despite efforts to regulate legitimate pain 
medications, the availability of illicit and synthetic opioids has increased. 
Predictive modeling be used to identify factors that contribute to the opioid
misuse and identify individuals at risk for addiction. A central task in 
applying predictive analytic methods is selecting the best model for a given
question and the available data. This paper compares several linear and non-
linear classification models of pain reliever misuse and abuse using a sample 
of N=114,038 respondents from a large national survey (NSDUH 2015-2016). 
Classification models vary in terms of complexity, accuracy, and 
interpretability. Simple models provide interpretable solutions but often at
the cost of low accuracy, whereas complex models can provide higher accuracy 
...
synthetic opioids such as fentanyl \cite{jones15}. The sharp increase in 
prescription overdose deaths (POD) and heroin overdose deaths (HOD) are 
correlated \cite{muhuri13, unick13}. The dosage levels and potency of 
illicit and synthetic opioids are largely unknown which increases the 
risk of overdose death. Predictive analytics can provide useful tools to 
understanding the opioid crisis given the huge amount of information being 
generated from electronic medical records (EMRs), clinical research data, 
and population-level data \cite{hay13, herland14}. The present study 
compares several predictive models of pain reliever misuse and abuse to 
analyze some of the features that contribute to the misuse and abuse 
...
Trying to track an epidemic in real-time from multitudes of 
...
Supervised
machine learning approaches are considered in this study to identify 
characteristics of individuals susceptible to opioid misuse and abuse and 
features related to opioid addiction. 




This project considers whether opioid dependency and addiction can be predicted 
from population-level public health data 
...
prescription medications, and illicit drug use. 




Understanding the features that contribute to opioid addiction 
can identify underlying risk factors and increase awareness of potential 
opioid abuse for patients and health care providers. 
...
Mobile health applications can monitor patient medication 
...
dosages can be difficult to obtain based on self-reports. 
...
The goal of this project is to use machine 
...
\begin{table}
  \caption{Classification Models Used to Predict Pain Reliever Misuse and Abuse
  \cite{samhsa16}}
  \label{tab:freq}
  \begin{tabular}{ll}
    \toprule
...
The following steps were included in the project workflow: (1) Download and 
extract the data, (2) Data cleaning and preparation, (3) Exploratory data 
analysis, (4) Data visualization, (5) Analysis of classification models of
...
representative distribution selected from 6,000 area segments. 

The sample design used five state sample size groups drawing more heavily 
from the eight states with the largest population (e.g., CA, FL, IL, MI, NY,
OH, PA, TX) which together account for 48 percent of total U.S. population aged 12 or older. 
...
(MHTRTMT). The target variable was Heroin Use (HEROINEVR). Next 
...
\begin{table*}[ht]
  ...
  \begin{tabular}{llllllll}
    ...
    Logistic Regression & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 25002 & 2509 & 0.900 & 0.986 & 0.909 & 0.946 \\
     & PRL Misuse & 344 & 654 &  &  &  & \\
    \midrule
    Linear Discriminant Analysis  & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 24667 & 2238 & 0.898 & 0.973 & 0.917 & 0.944 \\
     & PRL Misuse & 679 & 925 &  &  &  & \\
    \midrule
    Quadratic Discriminant Analysis  & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 23386 & 1836 & 0.867 & 0.923 & 0.927 & 0.925 \\
     & PRL Misuse & 1960 & 1327 &  &  &  & \\
    \midrule
    
    Support Vector Machines  & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 25436 & 0 & 1.0 & 1.0 & 1.0 & 1.0 \\
     & PRL Misuse & 0 & 3163 &  &  &  & \\
    \midrule
    Naive Bayes  & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 25345 & 3133 & 0.890 & 0.999 & 0.890 & 0.941 \\
     & PRL Misuse & 1 & 30 &  &  &  & \\
    \midrule
    
    Neural Network & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse &  &  &  &  &  & \\
     & PRL Misuse &  &  &  &  &  & \\
    \midrule
    Decision Trees & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 25042 & 2572 & 0.899 & 0.988 & 0.907 & 0.946 \\
     & PRL Misuse & 304 & 591 &  &  &  & \\
    \midrule
    Random Forests & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 25054 & 2518 & 0.901 & 0.989 & 0.909 & 0.947 \\
     & PRL Misuse & 292 & 645 &  &  &  & \\
    \midrule
