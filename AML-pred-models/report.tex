...
opioids. This study compares different predictive models to classification 
pain reliever misuse and abuse in order to select the best model(s) to 
address the question and understand features that contribute to MUPO. 
...
drug and alcohol treatment. The public NSDUH datasets do not include geographic
location or demographic variables related to ethnicity or immigration status. 
It can be difficult to obtain reliable information about drug use based on
self-reports; however, surveys provide data on a range of issues that people 
may be reluctant to disclose such as drug use and mental health problems.
NSDUH data has been used for identifying groups at high risk for substance use, 
and the co-occurrance of substance use and mental disorders. The target 
variable for the study was any misuse and abuse prescription pain reliever. 
The features of interest were selected demographic variables, medication 
usage, and use of illicit drugs (e.g., heroin, cocaine, amphetamines). 
...
model has advantages and limitation when applied to a given question taking
into account the available data that are described further below. 
...
The following steps were performed as part of the data preparation and 
analysis: (1) Download and extract the data, (2) Data cleaning and preparation, 
(3) Exploratory data analysis and Visualization, (4) Construct and analyze classification models of pain reliever misuse and abuse (PRLMA). 




Data cleaning and preparation was completed using a python interactive 
notebook . After downloading NSDUH datasets for 2015 and 
2016 from the SAMHDA website \cite{samhsa18} the data files were saved as a data frame object \cite{mckinney17}.  


 NSDUH 
data files for 2015 and 2016 

consisted of N=57,146 respondents from 2015 (26,736 male, 30,410 female)
...
As described in the NSDUH codebook, the sampling design is weighted across 
...
population \cite{samhsa18}. In the public use data files all identifying 
