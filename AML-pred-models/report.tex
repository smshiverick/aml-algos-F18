...
to reduce computational demands. The radial basis function (RBF) kernel (i.e., 
...
The \emph{Naive Bayes} classifier
...
The methods used in this project could be extended to better approximate big data 
