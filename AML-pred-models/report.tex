...
As the statistician George Box stated, "All models are wrong, but some 
models are useful." \cite{box05}. There are advantages and limitations for
any classification model that you can select; logistic regression is one of 
...
The goal of the current study is to compare predictive models of prescription
pain reliever misuse and abuse and better understand some of the factors 
that contribute to the opioid dependence and addiction. 
...
opioids pain and heroin use \cite{unick13}, the exploratory analysis focused 
on individuals who reported misusing or abusing pain relievers or using heroin, 
Figure 1 shows that the proportion of pain reliever misuse and abuse was 
higher among individuals who reported using heroin than those who had not. 
In addition, pain reliever misuse and abuse and heroin use both varied by sex 
(Figure 3). Although, a greater number of females than males reported using any 
pain relievers , the left panel of figure 3 shows that more females than males
