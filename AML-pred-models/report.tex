...
\begin{table}
  ...
  \begin{tabular}{llllll}
    \toprule
              & \textbf{PRLMISAB} & & & \textbf{Non-PRLMISAB} & \\
              & N & \% &  & N & \% \\
    \midrule
...
\begin{table*}[ht]
  ...
  \begin{tabular}{llllllll}
    ...
    \midrule
    \textbf{K-Nearest Neighbors} & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 25114 & 320 & 89.5\% & 0.900 & 0.870 & 0.870 \\
     & PRL Misuse & 2609 & 467 &  &  &  & \\
    \midrule
    \textbf{Logistic Regression} & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 25002 & 2509 & 90\% & 0.986 & 0.909 & 0.946 \\
     & PRL Misuse & 344 & 654 &  &  &  & \\
    \midrule
    \textbf{Linear Discriminant Analysis (LDA)} & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 24668 & 2239 & 89.8\% & 0.973 & 0.917 & 0.944 \\
     & PRL Misuse & 678 & 924 &  &  &  & \\
    \midrule
    \textbf{Quadratic Discriminant Analysis (QDA)} & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 23165 & 1780 & 86.1\% & 0.914 & 0.9929 & 0.921 \\
     & PRL Misuse & 2181 & 1383 &  &  &  & \\
    \midrule
    \textbf{Support Vector Classifier (SVM)} & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 25201 & 233 & 90.4\% & 0.900 & 0.890 & 0.880 \\
     & PRL Misuse & 2514 & 562 &  &  &  & \\
    \midrule
    \textbf{Naive Bayes} & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 25345 & 3133 & 89\% & 0.999 & 0.890 & 0.941 \\
     & PRL Misuse & 1 & 30 &  &  &  & \\
    \midrule
    \textbf{Neural Network (MLP)} & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 25088 & 346 & 90.6\% & 0.910 & 0.890 & 0.880 \\
     & PRL Misuse & 2366 & 710 &  &  &  & \\
    \midrule
    \textbf{Decision Trees} & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 25042 & 2572 & 89.9\% & 0.988 & 0.907 & 0.946 \\
     & PRL Misuse & 304 & 591 &  &  &  & \\
    \midrule
    \textbf{Random Forests} & & No Misuse & PRL Misuse &  &  &  & \\
     & No Misuse & 25026 & 2298 & 90.1\% & 0.987 & 0.909 & 0.946 \\
     & PRL Misuse & 320 & 665 &  &  &  & \\
    \midrule
    \textbf{Gradient Boosted Trees} & & No Misuse & PRL Misuse &  &  &  & \\
...
The slope parameter, $\beta_2$ , is interpreted as the change in the log of 
the odds of Y occurring (i.e., change in the log of odds ratio) given a unit 
change in X (holding effects of other variables constant). The intercept, β1, 
is the log of the odds ratio when X is 0 \cite{gujarati09}. The parameters 
relate to the log of the odds ratio rather than to the dependent variable
directly.
